...
public class User_DAO {
    ...
    public User_M createAndGet(User_M obj)
    {
        try {
            User_M user=null;
          int result=  TransactionDAO.create(obj);
     ...
     public User_M getLastUser()
    {
        try {
        
            long id=TransactionDAO.queryRawValue("select MAX(use_id) from _user");
            User_M obj2=getOne((int) id);
            return obj2;
